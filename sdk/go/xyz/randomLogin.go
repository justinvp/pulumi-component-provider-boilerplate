...
func NewRandomLogin(ctx *pulumi.Context,
	...
	if args.PetName == nil {
		return nil, errors.New("invalid value for required argument 'PetName'")
	}
	var resource RandomLogin
	err := ctx.RegisterRemoteComponentResource("xyz:index:RandomLogin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
